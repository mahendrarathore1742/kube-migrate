    ...
    <aside className="fixed top-0 left-0 w-64 h-screen bg-[#080808] border-r border-[#1a1a2e] flex flex-col z-30">
      ...
      <div className="px-3 py-3 border-b border-[#1a1a2e]">
        <button
          ...
          className="w-full flex items-center justify-between px-3 py-2 rounded-lg bg-[#0d0f18] hover:bg-[#141726] border border-[#1e2238] hover:border-blue-500/40 text-slate-400 hover:text-white transition-all text-xs group"
          title="Search docs (Ctrl+K or ⌘K)"
        >
          <span className="flex items-center gap-2">
            <svg className="w-3.5 h-3.5 text-slate-500 group-hover:text-blue-400 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
            </svg>
            <span>Search docs...</span>
          </span>
          <kbd className="px-1.5 py-0.5 text-[10px] font-mono text-slate-400 bg-[#161826] border border-[#282d46] rounded shadow-inner">
            ⌘K
          </kbd>
        </button>
      </div>
